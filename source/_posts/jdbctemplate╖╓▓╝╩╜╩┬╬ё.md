title: jdbctemplate分布式事务
date: 2016.01.17
categories: java #分类
tags: [java, spring, jdbctemplate, 分布式事务]
toc: true
---
  	
## 简介
    分布式事务是数据库的高级功能，它相对复杂，又不可避免，下面以本人的github项目:
[https://github.com/njkfei/spring-jta-jdbctemplate.git](https://github.com/njkfei/spring-jta-jdbctemplate.git)为例进行说明.
相关技术要素如下：
* spring 提供框架管理功能。
